...
/**
 * This class provides a method of creating a smooth gradient
 * between up to 10 evenly distributed colour points.
 * To create a gradient, add up to 10 colours
 * and call <code>createGradient</code>.
 * <code>getColour</code> or <code>getGradient</code> can be used
 * to retrieve the resultant colours.
 *
...
public class Gradient {
    ...
    /**
     * Add a colour to the gradient list. A maximum of 10 colour points
     * are allowed, any more will throw an exception.
     *
    ...
    /**
     * Calculate the RGB deltas between two different colour values
     * and over a given number of timesteps.
     * <code>createGradient</code> uses this function to connect
     * the gradient points together.
     *
     * @param start the starting colour.
     * @param end   the ending colour.
     * @param steps the number of steps required to get
     *              from <code>start</code> to <code>end</code>.
     * @return a <code>double[3]</code> array returning
     * the red, green and blue delta values.
     */
     ...
     * This method defaults to using 256 steps.
     */
     ...
     * Create the gradient using the current gradient list.
     *
     * @param numSteps the number of steps to take from the first
     *                 colour to the last.
     */
